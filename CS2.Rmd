...
##### Performance Rating
```{r, fig.width=10}
ggplot(data=noattrit, aes(x=factor(noattrit$PerformanceRating))) + geom_histogram(stat="count",position = "dodge", fill="steelblue4") +xlab(" ") + scale_x_discrete(name='Education') + ggtitle("Everyone Receives a Performance Rating of Excellent or Outstanding")+theme(plot.title=element_text(hjust=0.5))
